 ...
 * Plugin URI: https://tncflipbook.com/
 * Description: The best PDF Reader & 3D FlipBook Plugin for WordPress since 2014, Powers up your WordPress website with a smart and modern PDF Reader & FlipBook.
 * Version: 12.4.2
 * Author: ThemeNcode LLC
 * Author URI: https://themencode.com
 * Text Domain: pdf-viewer-for-wordpress
...
define( 'PVFW_PLUGIN_VERSION', '12.4.2' );
...
function tnc_pvfw_include_csf_files() {
...
add_action( 'init', 'tnc_pvfw_include_csf_files', 1 );
...
function tnc_pdf_add_links_to_plugin_page ( $actions ) {
 ...
 function tnc_pdf_visit_plugin_site_links( $links_array, $plugin_file_name, $plugin_data, $status ) {
	if ( strpos( $plugin_file_name, basename(__FILE__) ) ) {
		$links_array[] = '<a class="tnc_pdf_visit_plugin_site" target="_blank" href="https://docs.themencode.com/docs/pdf-viewer-for-wordpress/">Documentation</a>';
	} 
	return $links_array;
}

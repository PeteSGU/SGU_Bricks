 ...
 * Autoload class.
 *
 * @class WP_Grid_Builder_Bricks\Autoload
 * @since 1.0.0
 */
class Autoload {
	...
	public function load_class( $class ) {
		...
		while ( false !==
			$pos = strrpos( $prefix, '\\' ) // phpcs:ignore WordPress.CodeAnalysis.AssignmentInCondition.FoundInWhileCondition
		) {
...
$loader->add_namespace( 'WP_Grid_Builder_Bricks', WPGB_BRICKS_PATH );

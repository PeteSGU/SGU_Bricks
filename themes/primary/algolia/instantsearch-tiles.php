...
<style>
	...
	.ais-Hits { width: 100%;}
	ol li { padding: 3rem 1rem 1rem 2rem; border-radius: 8px; box-shadow: 1px 2px 4px 2px var(--neutral-trans-20); background-color: var(--bricks-color-white); display: flex;}
	ol.ais-Hits-list { display: grid; grid-gap: 3rem; grid-template-columns: repeat(4, 1fr); }
	/*ol li article { grid-template-columns: 1fr; display: grid; grid-gap: 1.2rem 0;}*/
	ol .ais-Hits-item h2 {line-height: 15px !important; margin-bottom: 2rem;}
	ol.ais-Hits-list a.ais-hits--title-link{ font-size: 2rem !important; font-weight: 700 !important; letter-spacing: -1px; }
	.results-grid { display: grid; grid-gap: 3rem; grid-template-columns: 1fr; }
	.results-grid h3.widgettitle { color: var(--primary); font-size: 3rem;}
	ul.ais-Menu-list li {display: inline; list-style-type: none; padding-right: 20px; float: left; padding: 1rem 2rem;
			border-radius: 8px;	box-shadow: 1px 2px 4px 2px var(--neutral-trans-20); background-color: var(--primary);margin-right: 1rem;}
	li.ais-Menu-item.ais-Menu-item--selected {background-color: #ff6400;}	
	li.ais-Hits-item > article {display: grid; grid-template-columns: 1fr; grid-gap: 1rem;}
	ul.ais-Menu-list li > div > a.ais-Menu-link{ display: flex; justify-content: flex-start; width: auto; column-gap: 10px; color: white;}
	div#algolia-pagination {text-align: center;}
	}
	
	@media screen and (max-width: 1100px) {
		ol.ais-Hits-list { grid-template-columns: repeat(3, 1fr); }
	}
	
	@media screen and (max-width: 900px) {
		ol.ais-Hits-list { grid-template-columns: repeat(2, 1fr); }
	}
	
	@media screen and (max-width: 600px) {
		ol.ais-Hits-list { grid-template-columns: 1fr; }
	}
...
<main id="resultsWrap">
	...
	<div id="ais-wrapper">
		...
		<aside id="ais-facets" class="results-grid">
			<div>
				<h3 class="widgettitle"><?php esc_html_e( 'Sort Results by Type', 'wp-search-with-algolia' ); ?></h3>

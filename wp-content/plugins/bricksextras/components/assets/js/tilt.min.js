...
function xTilt(){let e=function(e){let t=!1,i=!1,n=e.querySelectorAll("[data-x-tilt]");n.forEach(function(e){let n=e.getAttribute("data-x-tilt"),a=n?JSON.parse(n):{},d={gyroscope:!1,...a.config};VanillaTilt.init(e,d),t=!0,window.addEventListener("resize",function(){!0==(i=window.innerWidth<=a.breakpoint)&&!0===t&&(e.vanillaTilt.destroy(),t=!1),!1===i&&(VanillaTilt.init(e,d),t=!0)})})};function t(t){if(void 0===t.detail.queryId){if(void 0===t.detail.popupElement)return;e(t.detail.popupElement)}setTimeout(()=>{document.querySelector(".brxe-"+t.detail.queryId)&&e(document.querySelector(".brxe-"+t.detail.queryId).parentElement)},0)}e(document),document.addEventListener("bricks/ajax/load_page/completed",t),document.addEventListener("bricks/ajax/pagination/completed",t),document.addEventListener("bricks/ajax/popup/loaded",t),document.addEventListener("bricks/ajax/end",t),window.doExtrasTilt=e}document.addEventListener("DOMContentLoaded",function(e){bricksIsFrontend&&xTilt()});
	...
	PVFWOF::createSection(
		...
		array(
			...
			'fields' => array(
				...
				array(
					'type'    => 'subheading',
					'content' => esc_html__( 'Specify Global Default setting here. Options in this section applies to Automatic Link and iFrame options as well as individual flipbooks where you sekect use global setting.', 'pdf-viewer-for-wordpress' ),
				),
			  ...
			  <div class="tnc-usefull-section">
				<div class="tnc-usefull-container">
					  ...
					  <div  class="tnc-usefull-grid">
							<a target="_blank" href="https://themencode.com/tnc-flipbook-live-preview/">

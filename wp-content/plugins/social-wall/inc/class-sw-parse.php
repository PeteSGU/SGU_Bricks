...
class SW_Parse
{
	...
	public static function get_full_name( $data, $post, $plugin = '' ) {
		...
		if ( $plugin === 'youtube' ) {
			...
			if (isset($data['tiktok'])) {
				$name = SBTT_Parse_Pro::get_username($data['tiktok']);
			}
		}
	...
	public static function get_avatar( $data, $post, $plugin = '' ) {
		...
		if ( $plugin === 'youtube' ) {
			...
			if (isset($data['tiktok'])) {
				$avatar = SBTT_Parse_Pro::get_avatar_url($data['tiktok']);
			}
		}
	...
	public static function get_account_link( $account_data, $post, $plugin = '' ) {
		...
		if ( $plugin === 'youtube' ) {
			...
			if (isset($account_data['tiktok'])) {
				$permalink = SBTT_Parse_Pro::get_profile_url($account_data['tiktok']);
			}
		}
